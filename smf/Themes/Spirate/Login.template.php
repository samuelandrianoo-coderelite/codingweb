...
function template_ajax_login()
{
	...
	echo '<div class="roundframe">
			...
			<input   class="form-control rounded-3" placeholder="', $txt['username'], '" type="text" id="ajax_loginuser" name="user" size="20" value="', $context['default_username'], '" required>
			<label for="ajax_loginuser">', $txt['username'], '</label>
			</div>
			<div class="form-floating mb-3">
			<input  type="password" class="form-control rounded-3"   placeholder="', $txt['password'], '" id="ajax_loginpass" name="passwrd" value="', $context['default_password'], '" size="20" required>
			...
			<button class="w-100 mb-2 btn btn-lg rounded-3 btn-primary" type="submit">', $txt['login'], '</button>
  ...
  <div class="modal-content rounded-3 shadow">
	...
	<div class="modal-body p-5 pt-0">
	  <form action="', $context['login_url'], '" method="post" accept-charset="', $context['character_set'], '" name="frmLogin" id="frmLogin">
		<div class="form-floating mb-3">
		  <input  class="form-control rounded-3" id="floatingInput" placeholder="name@example.com" type="text" name="user" size="20">
		  <label for="floatingInput">', $txt['username'], '</label>
		</div>
		<div class="form-floating mb-3">
		  <input class="form-control rounded-3" id="floatingPassword" placeholder="', $txt['password'], '" type="password" name="passwrd" size="20">
