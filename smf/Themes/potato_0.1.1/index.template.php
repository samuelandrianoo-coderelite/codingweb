...
function template_html_above()
{
	...
	echo '<!DOCTYPE html>
<html', $context['right_to_left'] ? ' dir="rtl"' : '', !empty($txt['lang_locale']) ? ' lang="' . str_replace("_", "-", substr($txt['lang_locale'], 0, strcspn($txt['lang_locale'], "."))) . '"' : '', ' class="', sycho_current_mode(), '-mode">
<head>
...
function template_body_below()
{
	...
	echo '
		<ul>
			<li class="footer-links"><a href="', $scripturl, '?action=help">', $txt['help'], '</a> ', (!empty($modSettings['requireAgreement'])) ? '| <a href="' . $scripturl . '?action=agreement">' . $txt['terms_and_rules'] . '</a>' : '', ' | <a href="#top_section">', $txt['go_up'], ' &#9650;</a></li>
<li class="">© 2024 Jeremy Savio (ErereProject) - All Rights Reserved.</li>
		</ul>';
