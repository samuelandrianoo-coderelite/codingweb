...
function template_pm_popup()
{
	...
	echo '
	<div class="w-100">
		<div class="pm_bar px-3 clearfix">
	...
	if (empty($context['unread_pms']))
		echo '<hr class="my-1">
			<div class="no_unread px-3">', $txt['pm_no_unread'], '</div>';
	else
	{
...
function template_single_pm($message)
{
	...
	echo '
			...
			<div class="postarea">
				<div class="keyinfo">
					...
					<div class="postinfo"><small> ',$message['member']['link'],', </small>';

	// Show who the message was sent to.
	echo '
						<span class="small"><strong> ', $txt['sent_to'], ':</strong> ';
	...
	if (!empty($message['recipients']['bcc']))
		echo '
						<span class="small"><strong> ', $txt['pm_bcc'], ':</strong> ', implode(', ', $message['recipients']['bcc']), ' </span>';
