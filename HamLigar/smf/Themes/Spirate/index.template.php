...
<head>
	...
	*/ 
	...
	$context['css_header'][] = '
	:root{
		--smf-primary: '.$settings['spirate_brand_color'].'; 
		--smf-primary-rgb: '.hexToRgb($settings['spirate_brand_color']).'; 
		--smf-body-bg:  '.$settings['spirate_body_bg'].';
		--smf-body-color:  '.$settings['spirate_body_color'].';
		--smf-link-color:  '.$settings['spirate_link_color'].';
		--smf-btn-color:  '.$settings['spirate_btn_color'].';
		--smf-btn-color-rgb: '.hexToRgb($settings['spirate_btn_color']).'; 
		--smf-card-bg:  '.$settings['spirate_card'].'; 
	} ';
...
function template_user(){
	global $context, $settings, $scripturl, $txt, $modSettings, $maintenance,$adminSection, $fluidcontainer;
		...
		<nav class="user-nav navbar">
			  ...
			  theme_linktree(); 
	   echo'
	   <ul class="user_menu py-3 nav justify-content-end ms-auto  position-relative"> 
	   <li class="nav-item">
...
/**
 *by nicholas-summers 2016
 */
function rgb_best_contrast($color) {
