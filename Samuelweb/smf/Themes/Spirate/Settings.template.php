...
function template_settings()
{
	...
	$context['theme_settings'] = array(
		...
		array(
			'id' => 'spirate_card',
			'label' => $txt['spirate_card'], 
			'description' =>  $txt['spirate_card_desc'],
			'type' => 'color',
		),
		array(
			'id' => 'spirate_link_color',
			'label' => $txt['spirate_link_color'],  
			'type' => 'color',
		),
		array(
			'id' => 'spirate_body_bg',
			'label' => $txt['spirate_body_bg'],  
			'type' => 'color',
		),
		array(
			'id' => 'spirate_body_color',
			'label' => $txt['spirate_body_color'],  
			'type' => 'color',
		),
		array(
			'id' => 'spirate_btn_color',
			'label' => $txt['spirate_btn_color'],  
			'type' => 'color',
		),
		'',
		array(
