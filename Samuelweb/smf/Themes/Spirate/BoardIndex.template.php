...
function template_main()
{
	...
	echo'<div id="boards" class="card d-block mt-3 mb-2 p-3">';
...
function template_spiate_result(){
	...
	<div class="card p-3 d-block mb-2">
	 <a href="#" id="loadNews"  class="badge rounded-pill bg-primary p-3">
	 <span class="main_icons feed"></span>',$txt['spiratenews'],'</a>
	 <a href="#" id="loadBoardNews"  class="float-end dropdown-toggle badge rounded-pill bg-primary  p-3">
	',$txt['boardnews'].'
     </a>
	 <div class="d-inline-block">
	 	<a href="#" class="badge rounded-pill bg-primary p-3 dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
		 <span class="main_icons news"></span> ',$txt['recent_posts'],'</a>
