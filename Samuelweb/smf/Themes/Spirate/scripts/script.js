...
{
	popup_class = 'modal-dialog modal-dialog-scrollable popup_window ' + (this.opt.custom_class ? this.opt.custom_class : 'description');
	...
	$('body').append('<div id="' + this.popup_id + '" class="popup_container modal "><div class="' + popup_class + '"><div class="modal-content"><div class="h2 popup_heading modal-header p-4"><div>' + icon + this.opt.heading + '</div><a href="javascript:void(0);" class="main_icons hide_popup"></a></div><div class="popup_content modal-body p-4">' + this.opt.content + '</div></div></div></div><div class="modal-backdrop fade show"></div>');
...
function create_ajax_indicator_ele()
{
	...
	<span class="visually-hidden">${ajax_notification_text}...</span>
	</div>
	</div>`;
