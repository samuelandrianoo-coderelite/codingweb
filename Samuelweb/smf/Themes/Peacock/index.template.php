...
function template_body_above()
{
	...
	echo '
	<div class="-mt-24 shadow-md skew-y-2 bg-gradient-to-r from-blue-400 via-purple-400 to-rose-400">
	<div class="py-24 -skew-y-2">
	<div id="top_section">
		<div class="inner_wrap">
		<div class="relative flex items-center h-20 px-4">
		<a class="menu_icon mobile_user_menu"><i class="fas fa-bars"></i></a>
		<h1 class="navbar-brand flex lg:flex-initial">
...
function template_body_below()
{
	...
	echo '
		<ul>
			...
			<li class="copyright">', theme_copyright(), ' <span style="font-size: 1em; color: Tomato;"><i class="fas fa-heart"></i></span> ', Wt_copy(), '</li>
		</ul>';
...
function theme_linktree($force_show = false)
{
	...
	if ($context['user']['is_logged'])
		echo '
						...
						<a href="', $scripturl, '"><i class="fas fa-map-marker-alt"></i></a>
					 </li>';
		...
		echo '
						<li class="button_', $act, '', !empty($button['sub_buttons']) ? ' subsections"' : '"', '>
							<a', $button['active_button'] ? ' class="active"' : '', ' href="', $button['href'], '"', isset($button['target']) ? ' target="' . $button['target'] . '"' : '', '>
								<i class="fa fa-', $act, ' fa-lg"></i><span class="textmenu ttip">', $button['title'], !empty($button['amt']) ? ' <span class="amt">' . $button['amt'] . '</span>' : '', '</span>
							</a>';
