...
function template_body_below()
{
	...
	template_footer_top_links();
		...
		echo '
			<ul>
				<li><a href="', $scripturl, '?action=help">', $txt['help'], '</a> ', (!empty($modSettings['requireAgreement'])) ? '| <a href="' . $scripturl . '?action=agreement">' . $txt['terms_and_rules'] . '</a>' : '', ' | <a href="#top_section">', $txt['go_up'], '</a> &#9650; | <a class="styleselectblue" href="'. $scripturl .'?variant=blue" title="'. $txt['colorblue'] .'"><i class="fa-solid fa-circle"></i></a><a class="styleselectred" href="'.$scripturl.'?variant=red" title="'.$txt['colorred'].'"><i class="fa-solid fa-circle"></i></a><a class="styleselectgreen" href="'. $scripturl. '?variant=green" title="'.$txt['colorgreen'].'"><i class="fa-solid fa-circle"></i></a></li>
